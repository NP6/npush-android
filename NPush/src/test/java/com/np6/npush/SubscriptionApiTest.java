...
public class SubscriptionApiTest {
    ...
    @Test
    public void testCallForPutSubscriptionWithBadRequestHttpResponse() throws InterruptedException, JsonProcessingException, ExecutionException {
    ...
    @Test
    public void testCallForPutSubscriptionWithOkHttpResponse() throws InterruptedException, ExecutionException {
        MockInterceptor interceptor = new MockInterceptor();
